...
class Simulator(object):
    ...
    def __init__(self, env, size=None, frame_delay=10, update_delay=1.0):
        ...
        for agent in self.env.agent_states:
            agent._sprite = pygame.transform.smoothscale(pygame.image.load(os.path.join("C:\Users\Chen\Downloads\smartcab\smartcab\images", "car-{}.png".format(agent.color))), self.agent_sprite_size)
